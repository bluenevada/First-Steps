...
print(type(b_2)) # auch ein String
...
print(not one and test) 
print(hello and test or one and b) 
print(hello is one) 
print(test is b or hello and b) 
print(not b is hello or one) 
print(hello or test or b) 